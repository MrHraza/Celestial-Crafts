...
class OrderForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'postcode': forms.TextInput(attrs={'class': 'form-control', 'required': 'required'}),
            'town_or_city': forms.TextInput(attrs={'class': 'form-control', 'required': 'required'}),
            'street_address1': forms.TextInput(attrs={'class': 'form-control', 'required': 'required'}),
